<?php
    ...
    $consulta = "UPDATE publicaciones SET IdPostulante = $idpostulante WHERE IdPublicacion = $idpost";
    mysqli_query($conexion, $consulta);

    date_default_timezone_set('America/Argentina/Buenos_Aires');
    $fechaHora = date('d/m/Y H:i');

    // $idUsuarioPostulacion = "SELECT IdUsuarioPostulacion FROM postulaciones WHERE IdPostulacion = '$idpostulante'";
    ...
    $crearNoti = "INSERT INTO notificaciones (IdUsuario, TipoNotificacion, FechaDeNotificacion, Mensaje, IdPublicacion, Estado, IdUsuarioCalificar) 
                  VALUES ('$idpostulante', 'Normal', '$fechaHora', 'Fuiste seleccionado para realizar un envio.', '$idpost', 0 , 0)";
